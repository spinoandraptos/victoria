...
if __name__ == "__main__":
    ...
    with Stage(configpath=MODES_CONFIG, remote=True) as stage:
        ...
        rr_LO = 7.47e9+50e6+0.8e6#7.415e9+50e6+0.5e6 
        rr_IF = -50e6
        ...
        # cav_IF = -34.6e6 # at 4mA
        cav_IF = -20.7e6 # at 1.5mA
        ...
        rr.operations = [
            ...
            ConstantReadoutPulse(
                ...
                I_ampx=0.6,#0.05*0.7*.8*.8*.6, #0.03
                pad=64*5,#300,#64*12, #1200, #
                digital_marker=DigitalWaveform("ADC_ON"),
                weights=r"C:\Users\qcrew\Desktop\Juncheng\victoria\config\weights\20260812_121243_weights.npz",
            ),
            # ConstantReadoutPulse(
            #     name="rr_readout_pulse",
