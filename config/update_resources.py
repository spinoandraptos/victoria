...
if __name__ == "__main__":
    ...
    with Stage(configpath=MODES_CONFIG, remote=True) as stage:
        ...
        (opx1000, qubit, rr, cav, qubit_EF, qubit_GF2, drive, yoko1, snail_drive, snail_drive_EF) = stage.get("opx1000", "qubit", "rr", "cavity", "qubit_EF", "qubit_GF2", "drive","yoko1", "snail_drive", "snail_drive_EF")
        ...
        qubit_EF.operations = [
            ...
            GaussianPulse(
                ...
                sigma=6,
                chop=4,
                I_ampx=1.5*0.5/1.43*0.5/0.515/.7*.5,#*0.5/0.426,
                Q_ampx=0.0,
            ),
