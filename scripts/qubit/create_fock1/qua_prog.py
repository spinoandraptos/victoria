...
# Single QUA script generated at 2026-08-14 16:55:05.463855
...
with program() as prog:
    ...
    with for_(v1,1,(v1<500001),(v1+1)):
        ...
        save(v1, r1)
        with for_(v2,16,(v2<616),(v2+32)):
            r2 = declare_output_stream()
            save(v2, r2)
            with for_(v3,200000000,(v3<210100000),(v3+200000)):
                r3 = declare_output_stream()
                save(v3, r3)
                play('qubit_gf2_drive'*amp(1.0), 'qubit_GF2')
                align()
                update_frequency('fock_drive', v3, 'Hz', False)
                play('stark_drive'*amp(1.0), 'fock_drive', duration=v2)
                align()
    ...
    with stream_processing():
        r2.buffer(19).save("length_drive")
        r3.buffer(51).save("drive_frequency")
        r4.buffer(19, 51).save_all("I")
        r4.buffer(19, 51).average().save("I_avg")
        r5.buffer(19, 51).save_all("Q")
        r5.buffer(19, 51).average().save("Q_avg")
...
config = {
    ...
    "elements": {
        ...
        "fock_drive": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'stark_drive': 'fock_drive.fock_drive_constant_200'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
    ...
    "pulses": {
        ...
        "fock_drive.fock_drive_constant_200": {
            "length": 200,
            "waveforms": {'Q': 'fock_drive.fock_drive_constant_200.waveform.Q', 'I': 'fock_drive.fock_drive_constant_200.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "fock_drive.fock_drive_constant_200.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        ...
        "fock_drive.fock_drive_constant_200.waveform.I": {
            "type": "constant",
            "sample": 0.4,
        },
