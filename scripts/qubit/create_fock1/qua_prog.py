...
# Single QUA script generated at 2026-08-06 10:02:29.567682
...
with program() as prog:
    ...
    with for_(v1,1,(v1<500001),(v1+1)):
        ...
        save(v1, r1)
        with for_(v2,-400000000,(v2<-299750000),(v2+500000)):
            r2 = declare_output_stream()
            save(v2, r2)
            align()
            play('qubit_gf2_drive'*amp(0.0), 'qubit_GF2')
...
config = {
    ...
    "elements": {
        ...
        "fock_drive": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'fock_drive': 'fock_drive.fock_drive_constant_2000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
    ...
    "pulses": {
        ...
        "fock_drive.fock_drive_constant_2000": {
            "length": 2000,
            "waveforms": {'Q': 'fock_drive.fock_drive_constant_2000.waveform.Q', 'I': 'fock_drive.fock_drive_constant_2000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
    },
    "waveforms": {
        ...
        "fock_drive.fock_drive_constant_2000.waveform.I": {
            "type": "constant",
            "sample": 0.2,
        },
        ...
        "fock_drive.fock_drive_constant_2000.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
