...
# Single QUA script generated at 2026-08-25 17:18:44.089066
...
with program() as prog:
    ...
    with for_(v1,1,(v1<500001),(v1+1)):
        ...
        save(v1, r1)
        with for_(v2,150000000,(v2<180075000),(v2+150000)):
            r2 = declare_output_stream()
            save(v2, r2)
            align()
            play('qubit_gf2_drive'*amp(1.0), 'qubit_GF2')
            update_frequency('fock_drive', v2, 'Hz', False)
            align('qubit_GF2', 'fock_drive')
            play('fock_drive'*amp(1.0), 'fock_drive')
            align('fock_drive', 'rr')
    ...
    with stream_processing():
        r2.buffer(201).save("drive_frequency")
...
config = {
    ...
    "elements": {
        ...
        "fock_drive": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'fock_drive': 'fock_drive.fock_drive_constant_fock1_180'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
    ...
    "pulses": {
        "fock_drive.fock_drive_constant_fock1_180": {
            "length": 720,
            "waveforms": {'Q': 'fock_drive.fock_drive_constant_fock1_180.waveform.Q', 'I': 'fock_drive.fock_drive_constant_fock1_180.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
    ...
    "waveforms": {
        ...
        "fock_drive.fock_drive_constant_fock1_180.waveform.I": {
            "type": "constant",
            "sample": 0.39,
        },
        "fock_drive.fock_drive_constant_fock1_180.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
