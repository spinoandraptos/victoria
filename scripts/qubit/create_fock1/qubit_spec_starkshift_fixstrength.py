...
class QubitSpec_Stark(Experiment):
    """Qubit spectroscopy"""
...
if __name__ == "__main__":
    ...
    pulses = {
        ...
        "qubit_pi": "qubit_constant_pi_300",#"qubit_constant_pulse",#"qubit_constant_pi_1500",
    ...
    expt = QubitSpec_Stark(FOLDER, modes, pulses, sweeps, datasets, **parameters)
