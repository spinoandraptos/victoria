...
class qubit_gf2_fock1_sweep_ampx(Experiment):
    """Qubit spectroscopy"""
...
if __name__ == "__main__":
    ...
    # DEL = Sweep(name="length_drive", start=4, stop=300, step=4, dtype=int)
    ...
    #     points=[0.5, 1.0 ]#0.25,0.5,0.75]
    # ) 
    D_AMPX = Sweep(name="d_ampx", start=-1.3, stop=1.3, num=51)
