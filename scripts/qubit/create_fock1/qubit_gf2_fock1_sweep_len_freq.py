...
class qubit_gf2_fock1_sweep_len_freq(Experiment):
    """Qubit spectroscopy"""
    ...
    def sequence(self):
        ...
        qua.align()
        qua.update_frequency(self.drive, self.drive_frequency) #, self.drive_frequency
...
if __name__ == "__main__":
    ...
    pulses = {
        "stark_drive": "fock_drive_constant_200",
    ...
    FREQ.stop = 210e6  # 60e6 #the 60e6 is from the lo used to generate ef pulse
    FREQ.num = 51
    ...
    expt = qubit_gf2_fock1_sweep_len_freq(FOLDER, modes, pulses, sweeps, datasets, **parameters)
