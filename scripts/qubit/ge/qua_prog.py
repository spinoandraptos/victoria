...
# Single QUA script generated at 2026-08-14 10:27:11.103677
...
with program() as prog:
    ...
    with stream_processing():
        r2.buffer(201).save("qubit_frequency")
...
config = {
    ...
    "elements": {
        "qubit": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'qubit_drive': 'qubit.qubit_constant_1000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
    ...
    "pulses": {
        "qubit.qubit_constant_1000": {
            "length": 1000,
            "waveforms": {'Q': 'qubit.qubit_constant_1000.waveform.Q', 'I': 'qubit.qubit_constant_1000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
        "rr.rr_readout_pulse": {
    ...
    "waveforms": {
        ...
        "qubit.qubit_constant_1000.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        "qubit.qubit_constant_1000.waveform.I": {
            "type": "constant",
            "sample": 0.39,
        },
    },
