...
if __name__ == "__main__":
    ...
    pulses = {
        "qubit_drive": 'qubit_gaussian_pi_pulse_1200',#"qubit_constant_pi_400",#"qubit_constant_pulse",#"qubit_constant_pi_1500",
    ...
    FREQ.start =190e6  # 40e6
    FREQ.stop = 220e6  # 60e6 #the 60e6 is from the lo used to generate ef pulse
    FREQ.num = 201
