...
if __name__ == "__main__":
    ...
    pulses = {
        "qubit_drive": 'qubit_constant_pi_120',#"qubit_constant_pi_400",#"qubit_constant_pulse",#"qubit_constant_pi_1500",
    ...
    FREQ.start =280e6  # 40e6
    FREQ.stop = 320e6  # 60e6 #the 60e6 is from the lo used to generate ef pulse
    FREQ.num = 51
