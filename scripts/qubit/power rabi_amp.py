...
if __name__ == "__main__":
    ...
    pulses = {
        "qubit_drive": "qubit_constant_pi_pulse_320",
    ...
    QD_AMPX = Sweep(name="qubit_pulse_amplitude", start=-1, stop=1, num=31)
    
    RO_AMPX = Sweep(
        name="ro_ampx",
        points=[0.5, 0.6, 0.7, 0.8, 1]#0.25,0.5,0.75]
    ) 
    sweeps = [N, RO_AMPX, QD_AMPX]
