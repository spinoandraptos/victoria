...
# Single QUA script generated at 2026-02-19 15:31:53.502474
...
with program() as prog:
    ...
    v4 = declare(fixed, )
    v5 = declare(fixed, )
    a1 = declare(fixed, value=[1.0, 1.01])
    with for_(v1,1,(v1<100001),(v1+1)):
        ...
        with for_each_((v2),(a1)):
            r2 = declare_stream()
            save(v2, r2)
            with for_(v3,-100000000,(v3<100250000),(v3+500000)):
                r3 = declare_stream()
                save(v3, r3)
    ...
    with stream_processing():
        r2.buffer(2).save("ro_ampx")
        r3.buffer(401).save("resonator_frequency")
        r4.buffer(2, 401).save_all("I")
        r4.buffer(2, 401).average().save("I_avg")
        r5.buffer(2, 401).save_all("Q")
        r5.buffer(2, 401).average().save("Q_avg")
            ...
            "fems": {
                "2": {
                    ...
                    "analog_inputs": {
                        "1": {
                            "gain_db": 0,
                            "downconverter_frequency": 7800000000.0,
                            "band": 3,
                        },
                    },
                    "type": "MW",
