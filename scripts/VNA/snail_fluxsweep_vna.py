...
dc_bias_list = np.arange(start=121000, stop=-121000, step=-5000) * 1e-6  # in amps A
center_freq = 7.77e9
freq_span = 40e6
reps = 1
power = -10
...
for dc_bias in dc_bias_list:
    ...
    with open(
        f"C:\\Users\\qcrew\\Documents\\eunice\\data\\2026-02-04\\snaillm_s21_sweep_freq_dc_bias_{dc_bias}"
        + ".pkl",
        "wb",
    ) as f:
        pickle.dump(
