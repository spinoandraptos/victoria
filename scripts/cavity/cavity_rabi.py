...
class Rabi(Experiment):
    ...
    primary_sweeps = ["cav_pulse_amplitude"]
    ...
    def sequence(self):
        ...
        self.cavity.play(self.cavity_drive, ampx=self.cav_pulse_amplitude)
...
if __name__ == "__main__":
    ...
    pulses = {
        ...
        "qubit_drive": "qubit_gaussian_pi_2000",
    ...
    QD_AMPX = Sweep(name="cav_pulse_amplitude", start=-1.3, stop=1.3, num=51)
    sweeps = [N, QD_AMPX]
