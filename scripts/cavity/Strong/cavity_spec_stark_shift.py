...
if __name__ == "__main__":
    ...
    pulses = {
        ...
        "stark_drive": "snail_drive_constant_4000",
    ...
    Q_AMPX = Sweep(
        ...
        points=[0.0, 0.1, 0.25, 0.5, 0.75, 0.9, 1, 1.25, 1.5, 1.75, 2.0]#0.25,0.5,0.75]
    ) 
    ...
    #         FREQ.num = 151
    #         sweeps = [N, FREQ]
    expt = stark_shift(FOLDER, modes, pulses, sweeps, datasets, **parameters)
    expt.run()
            # time.sleep(60)
