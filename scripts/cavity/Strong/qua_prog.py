...
# Single QUA script generated at 2026-08-06 09:59:06.644682
...
with program() as prog:
    ...
    with for_(v1,1,(v1<500001),(v1+1)):
        ...
        with for_each_((v2),(a1)):
            ...
            save(v2, r2)
            with for_(v3,200000000,(v3<210016667),(v3+33333)):
                r3 = declare_output_stream()
                save(v3, r3)
                play('qubit_gf2_pi_pulse'*amp(v2), 'qubit_GF2')
                align('qubit_GF2', 'fock_drive')
                play('fock_drive'*amp(v2), 'fock_drive')
                align('fock_drive', 'qubit')
    ...
    with stream_processing():
        r2.buffer(2).save("drive_ampx")
        r3.buffer(301).save("qubit_frequency")
        r4.buffer(2, 301).save_all("I")
        r4.buffer(2, 301).average().save("I_avg")
        r5.buffer(2, 301).save_all("Q")
        r5.buffer(2, 301).average().save("Q_avg")
...
config = {
    ...
    "elements": {
        "qubit_GF2": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'qubit_gf2_pi_pulse': 'qubit_GF2.qubitGF2_constant_pi_200'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
        ...
        "fock_drive": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'fock_drive': 'fock_drive.fock_drive_constant_72'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
            ...
            "intermediate_frequency": -359000000.0,
        },
    },
    "pulses": {
        ...
        "fock_drive.fock_drive_constant_72": {
            "length": 72,
            "waveforms": {'Q': 'fock_drive.fock_drive_constant_72.waveform.Q', 'I': 'fock_drive.fock_drive_constant_72.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
        "rr.rr_readout_pulse": {
    ...
    "waveforms": {
        ...
        "fock_drive.fock_drive_constant_72.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        ...
        "fock_drive.fock_drive_constant_72.waveform.I": {
            "type": "constant",
            "sample": 0.2,
        },
        "qubit.qubit_constant_pi_pulse_1200.waveform.I": {
            "type": "constant",
            "sample": 0.010641029583117832,
        },
