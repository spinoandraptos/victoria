...
if __name__ == "__main__":
    ...
    pulses = {
        ...
        "qubit_selective_pi": "qubit_constant_pi_260",
    ...
    # set the delay sweep
    DEL = Sweep(name="time_delay", start=4, stop= 1_000, step=40, dtype=int)

    DISPL_PHASE = Sweep(name="disp_phase", start=0.0, stop=0.7, step=0.1, dtype=float)
