...
class CavitySpec(Experiment):
    ...
    def sequence(self):
        ...
        qua.update_frequency(self.cavity_m, self.cavity_frequency)
        self.cavity_m.play(self.cavity_pulse, ampx = self.cav_ampx)
        qua.align(self.cavity_m, self.qubit)
...
if __name__ == "__main__":
    ...
    pulses = {
        "cavity_pulse": "cav_m_constant_1000",
