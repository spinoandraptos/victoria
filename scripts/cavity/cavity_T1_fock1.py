...
class CavityT1_fock1(Experiment):
    """Cavity T1"""
...
if __name__ == "__main__":
    ...
    DEL = Sweep(name="time_delay", start=16, stop=100_000, step=1000, dtype=int)
    sweeps = [N, DEL]
    ...
    expt = CavityT1_fock1(FOLDER, modes, pulses, sweeps, datasets, **parameters)
    expt.run()
