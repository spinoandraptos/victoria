...
if __name__ == "__main__":
    ...
    DEL = Sweep(name="time_delay", start=4, stop=150_000, step=1000, dtype=int)
    
    QD_AMPX = Sweep(name="cavity_drive_ampx", points= [1.0, 1.5, 1.95]) #needs to be floating point numbers 
