...
from ECD_functions import V_cat, Char_1D_singledisplacement, ECD


class ECD_cat_1d(Experiment):
...
if __name__ == "__main__":
    ...
    pulses = {
        "cav_disp": "cav_gaussian_80",
        "qubit_pi2": "qubit_gaussian_pi2_8",
        "qubit_pi": "qubit_gaussian_pi_8",
    ...
    CAV_AMPX = Sweep(name="ampx_x", start=-1.9, stop=1.9, step=0.1)
    # CAV_AMPX2 = Sweep(name="ampx_y", start=-1.35, stop=1.35, step=0.1)
    ...
    expt = ECD_cat_1d(FOLDER, modes, pulses, sweeps, datasets, **parameters)
    expt.run()
