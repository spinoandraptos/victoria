...
class ECD_cat_bsb(Experiment):
    ...
    def sequence(self):
        ...
        # qua.align()
        # self.qubit.play(self.qubit_pi2,phase=0.5)
        
        # self.cavity.play(self.cav_disp_state, ampx=amp_big, phase=0.0)  # 0.1 , ampx=1, phase=0.0
...
if __name__ == "__main__":
    ...
    CAV_AMPX = Sweep(name="ampx_x", start=-1, stop=1, step=0.15)
    CAV_AMPX2 = Sweep(name="ampx_y", start=-1, stop=1, step=0.15)
    ...
    expt = ECD_cat_bsb(FOLDER, modes, pulses, sweeps, datasets, **parameters)
