...
# Single QUA script generated at 2026-08-25 13:37:29.430177
...
with program() as prog:
    ...
    v3 = declare(fixed, )
    v4 = declare(fixed, )
    with for_(v1,1,(v1<1500001),(v1+1)):
        r1 = declare_output_stream()
        save(v1, r1)
        with for_(v2,48000000,(v2<52020000),(v2+40000)):
    ...
    with stream_processing():
        r2.buffer(101).save("cavity_frequency")
...
config = {
    ...
    "elements": {
        "qubit": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'qubit_pulse': 'qubit.qubit_constant_pi_pulse_6000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
        ...
        "cavity": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'cavity_pulse': 'cavity.cav_constant_2000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
