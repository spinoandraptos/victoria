...
# Single QUA script generated at 2026-08-14 13:36:45.647185
...
with program() as prog:
    ...
    v3 = declare(fixed, )
    v4 = declare(fixed, )
    with for_(v1,1,(v1<20001),(v1+1)):
        r1 = declare_output_stream()
        save(v1, r1)
        with for_(v2,0,(v2<50500000),(v2+1000000)):
            r2 = declare_output_stream()
            save(v2, r2)
            update_frequency('cavity', v2, 'Hz', False)
            play('cavity_pulse'*amp(0.75), 'cavity')
            align('cavity', 'qubit')
            align('qubit', 'rr')
    ...
    with stream_processing():
        r2.buffer(51).save("cavity_frequency")
...
config = {
    ...
    "elements": {
        "qubit": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'qubit_pulse': 'qubit.qubit_constant_2000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
    ...
    "pulses": {
        "qubit.qubit_constant_2000": {
            "length": 2000,
            "waveforms": {'Q': 'qubit.qubit_constant_2000.waveform.Q', 'I': 'qubit.qubit_constant_2000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
        "rr.rr_readout_pulse": {
    ...
    "waveforms": {
        "qubit.qubit_constant_2000.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        ...
        "qubit.qubit_constant_2000.waveform.I": {
            "type": "constant",
            "sample": 0.2,
        },
    },
