...
# Single QUA script generated at 2026-08-06 09:47:31.295129
...
with program() as prog:
    ...
    with for_(v1,1,(v1<100001),(v1+1)):
        ...
        save(v1, r1)
        with for_(v2,16,(v2<60750),(v2+1500)):
            r2 = declare_output_stream()
            save(v2, r2)
            play('cavity_drive'*amp(2.0), 'cavity')
    ...
    with stream_processing():
        r2.buffer(41).save("time_delay")
        r3.buffer(41).save_all("I")
        r3.buffer(41).average().save("I_avg")
        r4.buffer(41).save_all("Q")
        r4.buffer(41).average().save("Q_avg")
...
config = {
    ...
    "elements": {
        ...
        "cavity": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'cavity_drive': 'cavity.cav_constant_200'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
