...
class CavitySWAP2D_len_amp(Experiment):
    """Cavity T1"""
...
if __name__ == "__main__":
    ...
    DEL = Sweep(name="length_snail", start=4, stop=2000, step=32, dtype=int)
    ...
    expt = CavitySWAP2D_len_amp(FOLDER, modes, pulses, sweeps, datasets, **parameters)
    expt.run()
