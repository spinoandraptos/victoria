...
# Single QUA script generated at 2026-08-17 11:23:17.527819
...
with program() as prog:
    ...
    with for_(v1,1,(v1<100001),(v1+1)):
        ...
        save(v1, r1)
        with for_(v2,-250000000,(v2<-49000000),(v2+2000000)):
            r2 = declare_output_stream()
            save(v2, r2)
            update_frequency('snail_drive', v2, 'Hz', False)
            play('snail_pulse'*amp(1.0), 'snail_drive')
    ...
    with stream_processing():
        r2.buffer(101).save("snail_frequency")
...
config = {
    ...
    "elements": {
        "qubit": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'qubit_pulse': 'qubit.qubit_constant_pi_pulse_1000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
        ...
        "snail_drive": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'snail_pulse': 'snail_drive.snail_drive_constant_10000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
        ...
        "cavity": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'cavity_pulse': 'cavity.cav_constant_10000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
    ...
    "pulses": {
        "snail_drive.snail_drive_constant_10000": {
            "length": 10000,
            "waveforms": {'Q': 'snail_drive.snail_drive_constant_10000.waveform.Q', 'I': 'snail_drive.snail_drive_constant_10000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
        "rr.rr_readout_pulse": {
        ...
        "cavity.cav_constant_10000": {
            "length": 10000,
            "waveforms": {'Q': 'cavity.cav_constant_10000.waveform.Q', 'I': 'cavity.cav_constant_10000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
    },
    "waveforms": {
        "snail_drive.snail_drive_constant_10000.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        ...
        "snail_drive.snail_drive_constant_10000.waveform.I": {
            "type": "constant",
            "sample": 0.4,
        },
