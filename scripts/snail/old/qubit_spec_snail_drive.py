...
if __name__ == "__main__":
    ...
    pulses = {
        "drive_pulse": "drive_constant_240",
        "qubit_drive": 'qubit_gaussian_pi_640',#"qubit_constant_pi_400",#"qubit_constant_pulse",#"qubit_constant_pi_1500",
    ...
    FREQ.start =-80e6  # 40e6
    FREQ.stop = -70e6  # 60e6 #the 60e6 is from the lo used to generate ef pulse
    FREQ.num = 101
