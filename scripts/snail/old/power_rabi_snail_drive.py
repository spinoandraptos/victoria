...
class PowerRabi_snaildrive(Experiment):
    """Qubit spectroscopy"""
    ...
    def sequence(self):
        ...
        self.drive.play(self.drive_pulse, ampx=self.qubit_pulse_amplitude)
...
if __name__ == "__main__":
    ...
    pulses = {
        "drive_pulse": "drive_gaussian_pi_48",
    ...
    expt = PowerRabi_snaildrive(FOLDER, modes, pulses, sweeps, datasets, **parameters)
