...
class SNAILSpec_ge_Stark_2d(Experiment):
    """Qubit spectroscopy"""
...
if __name__ == "__main__":
    ...
    # )
    STARK_AMPX = Sweep(name="stark_ampx", start=0, stop=2.5, num=9)
    

    sweeps = [N, FREQ, STARK_AMPX]
    ...
    expt = SNAILSpec_ge_Stark_2d(FOLDER, modes, pulses, sweeps, datasets, **parameters)
