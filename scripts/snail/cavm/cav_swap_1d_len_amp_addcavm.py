...
class CavitySWAP1D_len_amp_addcavm(Experiment):
    """Cavity T1"""
    ...
    def sequence(self):
        ...
        self.cavity_m.play(self.cavity_m_drive, ampx = 1.0)
        qua.align(self.cavity, self.snail,self.cavity_m)
...
if __name__ == "__main__":
    ...
    pulses = {
        "cavity_m_drive": "cav_m_constant_200",
        "cavity_drive": "cav_constant_200",
        "qubit_pulse": "qubit_constant_pi_200",
    ...
    expt = CavitySWAP1D_len_amp_addcavm(FOLDER, modes, pulses, sweeps, datasets, **parameters)
    expt.run()
