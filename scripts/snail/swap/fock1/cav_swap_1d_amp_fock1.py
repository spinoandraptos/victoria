...
class CavitySWAP1D_amp_fock1(Experiment):
    """Cavity T1"""
...
if __name__ == "__main__":
    ...
    pulses = {
        ...
        "snail_pulse": "snail_drive_constant_60",
    ...
    SNAIL_AMPX = Sweep(name="snail_ampx", start=-1.5, stop=1.5, num=21)
    ...
    expt = CavitySWAP1D_amp_fock1(FOLDER, modes, pulses, sweeps, datasets, **parameters)
    expt.run()
