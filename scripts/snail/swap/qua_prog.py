...
# Single QUA script generated at 2026-08-10 20:39:40.270893
...
with program() as prog:
    ...
    v3 = declare(fixed, )
    v4 = declare(fixed, )
    with for_(v1,1,(v1<4001),(v1+1)):
        r1 = declare_output_stream()
        save(v1, r1)
        with for_(v2,16,(v2<2004),(v2+8)):
            r2 = declare_output_stream()
            save(v2, r2)
            reset_if_phase('cavity')
            reset_if_phase('snail_drive')
            play('cavity_drive'*amp(1.0), 'cavity')
            align('cavity', 'snail_drive')
            play('snail_pulse'*amp(1.0), 'snail_drive', duration=v2)
            align('qubit', 'snail_drive')
    ...
    with stream_processing():
        r2.buffer(249).save("length_snail")
        r3.buffer(249).save_all("I")
        r3.buffer(249).average().save("I_avg")
        r4.buffer(249).save_all("Q")
        r4.buffer(249).average().save("Q_avg")
...
config = {
    ...
    "elements": {
        "qubit": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'qubit_pulse': 'qubit.qubit_constant_pi_pulse_1200'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
        ...
        "snail_drive": {
            ...
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'snail_pulse': 'snail_drive.snail_drive_constant_2000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
            ...
            "intermediate_frequency": -833333.0,
        },
        "cavity": {
            "digitalInputs": {},
            "digitalOutputs": {},
            "outputs": {},
            "operations": {'cavity_drive': 'cavity.cav_constant_2000'},
            "hold_offset": {
                "duration": 0,
            },
            "sticky": {
            ...
            "intermediate_frequency": -26000000.0,
        },
    },
    "pulses": {
        "rr.rr_readout_pulse": {
        ...
        "qubit.qubit_constant_pi_pulse_1200": {
            "length": 1200,
            "waveforms": {'Q': 'qubit.qubit_constant_pi_pulse_1200.waveform.Q', 'I': 'qubit.qubit_constant_pi_pulse_1200.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
        "cavity.cav_constant_2000": {
            "length": 2000,
            "waveforms": {'Q': 'cavity.cav_constant_2000.waveform.Q', 'I': 'cavity.cav_constant_2000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
        "snail_drive.snail_drive_constant_2000": {
            "length": 2000,
            "waveforms": {'Q': 'snail_drive.snail_drive_constant_2000.waveform.Q', 'I': 'snail_drive.snail_drive_constant_2000.waveform.I'},
            "integration_weights": {},
            "operation": "control",
        },
    },
    "waveforms": {
        ...
        "rr.rr_readout_pulse.waveform.I": {
            "type": "arbitrary",
            "samples": [0.12] * 320 + [0.0] * 320,
            "is_overridable": False,
            "max_allowed_error": 1.0,
        },
        "snail_drive.snail_drive_constant_2000.waveform.I": {
            "type": "constant",
            "sample": 0.2,
        },
        "qubit.qubit_constant_pi_pulse_1200.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        "qubit.qubit_constant_pi_pulse_1200.waveform.I": {
            "type": "constant",
            "sample": 0.023044324324324326,
        },
        "snail_drive.snail_drive_constant_2000.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
        "cavity.cav_constant_2000.waveform.I": {
            "type": "constant",
            "sample": 0.39,
        },
        "cavity.cav_constant_2000.waveform.Q": {
            "type": "constant",
            "sample": 0.0,
        },
    },
