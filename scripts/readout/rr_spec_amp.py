...
if __name__ == "__main__":
    ...
    RO_AMPX = Sweep(
        name="ro_ampx",
        # points=[0.005, 0.01, 0.015,0.02, 0.03, 0.04,0.05, 0.08, 0.1]#0.25,0.5,0.75] #[0.01,0.05, 0.08,0.1, 0.2, 0.3, 0.4]
        points=[0.005, 0.01, 0.015,0.02, 0.03, 0.04, 0.045, 0.05, 0.055, 0.06]
